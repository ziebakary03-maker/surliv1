...
def _init_db():
    with _connect() as conn:
        with conn.cursor() as cur:
            ...
            # Migration additive (Postgres >= 9.6) : ajoute les colonnes du
            # scénario "boule sous gobelet" sans casser une table `jobs`
            # déjà existante (déploiement incrémental, section 25 : ne pas
            # réécrire inutilement le schéma).
            for column_sql in (
